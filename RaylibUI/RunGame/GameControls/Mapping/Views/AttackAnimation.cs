...
internal class AttackAnimation : BaseGameView
{
        ...
        false, 70, args.Location, forceRedraw)
    {
        ...
        ImageUtils.GetUnitTextures(args.Attacker, active, game, gameScreen.PlayerColours,gameScreen.Main.ActiveRuleSet.Paths,unitAnimations, attackerPos );
        ...
        ImageUtils.GetUnitTextures(args.Defender, active, game, gameScreen.PlayerColours,gameScreen.Main.ActiveRuleSet.Paths,unitAnimations,
            defenderPos);
        var explosion = 0;
