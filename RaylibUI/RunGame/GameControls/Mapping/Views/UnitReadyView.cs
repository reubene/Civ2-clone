...
public class UnitReadyView : BaseGameView
{
        ...
        currentView, viewHeight, viewWidth, true, 150, new []{ unit.CurrentLocation }, forceRedraw)
    {
        ...
        ImageUtils.GetUnitTextures(unit, activeInterface, gameScreen.Game, gameScreen.PlayerColours, gameScreen.Main.ActiveRuleSet.Paths,elements, ActivePos with{ Y = ActivePos.Y + Dimensions.TileHeight - activeInterface.UnitImages.UnitRectangle.Height.ZoomScale(gameScreen.Zoom)});
